        ...
        data: [
          {
            ...
            onPress: () => router.navigate('/(app)/(tabs)/settings/batchSize'),
          },
          {
            title: 'Maximum recommended daily lessons',
            type: 'page',
            key: 'max_lessons_per_day',
            onPress: () => router.navigate('/(app)/(tabs)/settings/maxLessons'),
          },
          {
            ...
            onPress: () =>
              router.navigate(
                '/(app)/(tabs)/settings/interleaveAdvancedLessons',
              ),
          },
        ],
      },
        ...
        data: [
          {
            ...
            onPress: () =>
              router.navigate('/(app)/(tabs)/settings/reviewOrdering'),
          },
        ],
      },
      {
        ...
        data: [
          {
            ...
            key: 'default_voice',
            onPress: () =>
              router.navigate('/(app)/(tabs)/settings/defaultVoice'),
          },
          {

...
const AssignmentsCard = ({
  ...
  const styles = assignmentsCardStylesheet
...
const assignmentsCardStylesheet = StyleSheet.create({
  badge: {
    backgroundColor: 'white',
    borderRadius: 18,
    paddingHorizontal: 7,
...
const CardButton = ({
  ...
  const styles = cardButtonStylesheet
...
const cardButtonStylesheet = StyleSheet.create({
  button: {
    color: 'transparent',
    backgroundColor: 'white',
  },
